...
using HypergapHolographic.Content;
#endif

namespace HypergapHolographic
{
    /// <summary>
    /// Updates, renders, and presents holographic content using Direct3D.
    /// </summary>
    internal class HypergapHolographicMain : IDisposable
    {
        ...
        public HypergapHolographicMain(DeviceResources deviceResources)
        {
        ...
        public HolographicFrame Update()
        {
            ...
            if (null != pointerState)
            {
                ...
                spritesRenderer.PositionHologram(
